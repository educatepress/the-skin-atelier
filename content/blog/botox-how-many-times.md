...
readTime: "4 min read"
featured: false
image: "/images/optimized/sincerely-media-mKHzuoIweyc-unsplash.webp"
---
...
効果を持続させるための最適な頻度は、部位にもよりますが**3〜6ヶ月**が目安です。
...
### Q. ボトックスで表情がなくなりませんか？
適切な量を適切な場所に注入すれば、表情は自然に保たれます。「能面のように」なるのは過剰注入の結果です。私の診療では「表情は残して、シワだけ減らす」をモットーにしています。
