...
const faqs = [
  {
    ...
    a: "目的によって異なります。肌の「土台作り」や「保湿」には\n日々のスキンケアが必須ですが、\n「シミを消す」「たるみを引き上げる」といった\n構造的な変化はスキンケアでは限界があります。\n\n限られた予算であれば、\nベースの保湿はシンプルなものにし、\n根本改善には美容医療を取り入れる\n「メリハリ引き算美容」をおすすめしています。",
  },
  {
    q: "30代・40代から美容医療を始める場合、\n何から始めるのがおすすめですか？",
    a: "まずは「光治療（IPL）」などで\n肌のトーンや色ムラを整えること、\nまたは「ボトックス」で将来の\n深いシワを予防することから始める方が多いです。\n\n今の肌の現在地によって優先順位は大きく変わるため、\n適切な情報の取捨選択が美肌への最短ルートになります。",
  },
  {
    q: "シミ取りレーザーと光治療（IPL）の\n違いは何ですか？",
    a: "「レーザー」は目立つシミを\nピンポイントで強力に破壊する治療、\n「光治療（IPL）」はお顔全体にマイルドな光を当て、\n薄いシミや赤み、くすみなどを総合的に少しずつ\n薄くしていく治療です。\n\n肌全体の透明感を底上げしたい場合は\nIPLが適しています。",
  },
  {
    q: "ボトックスは「やりすぎる」と\n表情が不自然になりませんか？",
    a: "注入する「量」と「打つ場所」によって\n仕上がりは完全にコントロールできます。\nシワを完全に消そうとして大量に打つと不自然になりがちですが、\n「表情は残しつつ、深く刻まれるシワだけをマイルドに抑える」\nという自然な打ち方も可能です。",
  },
  {
    q: "インナーケア（サプリや食事）は、\n本当に肌に効果があるのでしょうか？",
    a: "非常に重要です。肌は「最後に栄養が届く臓器」\nと言われており、鉄分やタンパク質などの\n栄養素が不足していると、\n外から高価な美容液を塗ってもすこやかな肌は作られにくいです。\n\n外からのケアと内からのケア両方が\n美肌づくりには不可欠です。",
  },
];
