...
const faqs = [
  ...
  },
  {
    ...
    a: "多くの方は、肌の「土台」が整っていない状態でレーザーを当ててしまいます。まずはフォトフェイシャル（IPL）で肌の土台をしっかりと耕し、ポレーションで栄養を届ける。この順番を守ることで、より少ない回数で、より美しい仕上がりが期待できます。",
  },
  {
  ...
  },
  {
    ...
    a: "個人差はありますが、1回の施術で2〜4週間程度の効果が持続します。月に1〜2回のペースで継続すると、肌のハリ・透明感が安定して維持できます。フォトフェイシャルとの組み合わせで相乗効果が期待できます。",
  },
  {
  ...
  },
  {
    ...
    a: "フォトフェイシャルは1回あたり2〜3万円、エレクトロポレーションは1〜2万円が目安です。ヒアルロン酸は使用する製剤と量によって5〜15万円、ボトックスは部位により2〜5万円程度です。詳細はカウンセリング時にご案内いたします。",
  },
  {
