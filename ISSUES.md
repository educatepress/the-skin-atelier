...
### X スレッドの文字数超過 + エビデンス引用なし
- **初検知:** 2026-04-23（REVIEW.md による初回レビューで発見）
- **原因:** generate-x-post.ts のプロンプトに文字数制限・引用ルールがなかった
- **対応:** プロンプトに120文字/ツイート制限、APA省略形の論文引用ルール、禁止ワードリストを追加
